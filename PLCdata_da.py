...
#--------------------------NEW GUI ITEMS -------------------------------------------#
    ...
    #lblheader = Label(frame_header, text="Header to analyze:")
    #lblheader.grid(row=1, column=0, padx=5, pady=10, sticky='w')
    ...
    uslentry = Entry(new_window, width=10)
    uslentry.grid(row=6, column=0, padx=10, pady=10, sticky='s')
    
    lslentry = Entry(new_window, width=10)
    lslentry.grid(row=6, column=1, padx=10, pady=10, sticky='s')
    
    lblusl = Label(new_window, text='CPK USL')
    lblusl.grid(row=6, column=0, padx=10, pady=35,sticky='n')
    
    lbllsl = Label(new_window, text='CPK LSL')
    lbllsl.grid(row=6, column=1, padx=10, pady=35, sticky='n')
    ...
    #label_result = Label(new_window, text='', bg='yellow', font='arial')
    #label_result.grid(row=8, column=0, padx=10, pady=10, sticky='w')
